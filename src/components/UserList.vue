                    ...
                    <table class="table table-striped">
                        <thead>
                            <tr>
                                ...
                                <th style="width: 20%;">No. Wa</th>
                                <th style="width: 40%;">Aksi</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr v-for="user in Users" :key="user.key">
                                <td style="font-size: 12px;vertical-align: middle;">{{ user.name }}</td>
                                <td style="font-size: 12px;vertical-align: middle;">{{ user.phone }}</td>
                                <td>
